...
@threestudio.register("gaussian-splatting-triplane")
class GaussianTriplane(BaseGeometry, GaussianIO):
    @dataclass
    ...
    def create_from_pcd_with_opacity(
        self, 
        pcd: BasicPointCloud, 
    ...
    def create_from(
        ...
        **kwargs,
        ...
        instance = GaussianTriplane(cfg, **kwargs)
        xyz = instance.get_xyz
        ...
        instance.create_from_pcd_with_opacity(pcd, 10, density)
        instance.training_setup()
        return instance
